...
const SignUp = () => {
  const [enteredEmail, emailInputHandler, emailBlurHandler, emailHasError] =
  ...
  const endPointUrl = signIn
    ? `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBI0E85_0_cTc67u7YpuNiEqJzaN3zuKUY`
    : `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBI0E85_0_cTc67u7YpuNiEqJzaN3zuKUY`;
