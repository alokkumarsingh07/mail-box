...
const Starred = () => {
  ...
  const url1 = `https://mail-box-client-fb15c-default-rtdb.firebaseio.com/emails`;
  const url2 = `https://mail-box-client-fb15c-default-rtdb.firebaseio.com/sent-emails/${senderMail}`;
