...
const MailListItems = (props) => {
  ...
  const url =
    mail.sender === email
      ? `https://mail-box-client-fb15c-default-rtdb.firebaseio.com/sent-emails/${senderMail}/${mail.id}.json`
      : `https://mail-box-client-fb15c-default-rtdb.firebaseio.com/emails/${mail.id}.json`;
