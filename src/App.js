...
function App() {
  ...
  const url1 =
    "https://mail-box-client-fb15c-default-rtdb.firebaseio.com/emails.json";
  const url2 = `https://mail-box-client-fb15c-default-rtdb.firebaseio.com/sent-emails/${email}.json`;
